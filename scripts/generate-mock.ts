...
// Define types locally for generator
...
const destPath = path.join(process.cwd(), 'public/mock-users.json');
fs.writeFileSync(destPath, JSON.stringify(ALL_USERS, null, 2));
console.log(`Generated 500 mock users at ${destPath}`);
